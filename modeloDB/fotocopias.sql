...
CREATE TABLE IF NOT EXISTS `fotocopias`.`Grupo` (
  ...
  `archivosAlumno` VARCHAR(1000) CHARACTER SET 'utf8' NOT NULL,
  `archivosProfesor` VARCHAR(1000) CHARACTER SET 'utf8' NOT NULL,
  `archivosDescargar` VARCHAR(1000) CHARACTER SET 'utf8' NOT NULL,
